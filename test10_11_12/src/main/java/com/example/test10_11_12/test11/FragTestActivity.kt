...
class FragTestActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 프래그먼트 기본 테스트
        // 방법 1) xml로 구성하는 방법   2) 코드로 구성하는 방법

        // 방법 1)
        // 경로 test11/src/main/res/layout/activity_main337.xml
        // 출력 방식이, 액티비티에 name으로 해당 프래그먼트를 지정해서 출력

        // 방법 2)
        // 액티비티 코드에서 해당 프래그먼트를 호출, 출력하는 방법
        // 경로 test11/src/main/java/com/example/test11/MainActivity338.kt
        ...
        // 백스탭을 설정시 커밋 이전 함수에서 설정 하면됨
        // 뒤로 가기 버튼을 클릭시 해당 액티비티를 종료하는게 아니라
        // 메모리상에 있는 프래그먼트를 재사용
