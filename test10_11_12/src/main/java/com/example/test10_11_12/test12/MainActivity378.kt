...
// 복붙 후 컴파일러 에러 부분
// 리사이클러 뷰에서 , 아이템 구성 요소
// ItemRecyclerviewBinding 없어서 만들기, 내용 복붙
// 경로 test12/src/main/res/layout/item_recyclerview.xml
// 메뉴 아이템 뷰 부분이 없어서 1차 문법 체크가 남
// 경로 test12/src/main/res/menu/menu_378.xml

// 뷰 상에서 액션바를 만들어서 theme 에서 액션바를 꺼야함
