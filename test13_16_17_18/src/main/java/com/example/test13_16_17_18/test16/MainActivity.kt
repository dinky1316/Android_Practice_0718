...
// 경로 test16/src/main/java/com/example/test16/MainActivity.kt
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requestPermissionLauncher = registerForActivityResult(
            // RequestMultiplePermissions : 이 부분은 다른 작업도 들어갑니다
        ...
        )
        {
            if (it.resultCode == RESULT_OK) {
                ...
                // select name, email from user where email = '123@gmail.com' and name = '123'
